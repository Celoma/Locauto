...
INSERT INTO `marque` VALUES ('Alpa Romeo'),('Alpine'),('Aston Martin'),('Audi'),('Austin'),('Bentley'),('BMW'),('Cadillac'),('Chevrolet'),('Chrysler'),('Citroën'),('Cupra'),('Dacia'),('Dodge'),('Ferrari'),('Fiat'),('Ford'),('Honda'),('Hyundai'),('Infiniti'),('Jaguar'),('Jeep'),('Kia'),('Land Rover'),('Lamborghini'),('Lotus'),('Maserati'),('Mazda'),('Mercedes'),('MG'),('Mini'),('Nissan'),('Opel'),('Peugeot'),('Porsche'),('Renault'),('Seat'),('Smart'),('Tesla'),('Toyota'),('Volkswagen'),('Volvo');
...
CREATE TABLE `type_de_client` (
  `id_type_de_client` int NOT NULL AUTO_INCREMENT,
  `libelle` varchar(100) NOT NULL,
...
INSERT INTO `type_de_client` VALUES ('Admin'),('Particulier'),('Entreprise'),('Association');
